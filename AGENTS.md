...
Do not create or update `documentation/history/` files. Record lasting decisions in the
relevant technical documentation and implementation progress in active plans; use Git
